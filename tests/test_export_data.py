...
def test_file(tmpdir):
    ...
    data = [{"mrid": "testmrid", "steady_state_rating": 10.10, "emergency_rating_15min": 20.20, "load_shedding": 20.20, "calculation_time": "2021-09-13T13:23:15Z"},
            {"mrid": "testmrid2", "steady_state_rating": 30.30, "emergency_rating_15min": 40.40, "load_shedding": 40.40, "calculation_time": "2021-09-13T13:23:15Z"}]
    app.dlr_limit_consumer.export_to_file(file_name, data)
